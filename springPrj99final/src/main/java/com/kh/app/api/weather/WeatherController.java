...
public class WeatherController {
	...
	public List getWeather() throws Exception{
		...
		//날씨정보 얻기
		        ...
		        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=ymZwXlzc6BhFoIY0eatru9WKi%2FakJRR1Dg9bN61dlWEnyDxiBG6puul4GekFogj7%2FPZ1pz%2FLU2PxdV4HTKAUvw%3D%3D"); /*Service Key*/
		        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
		        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("1000", "UTF-8")); /*한 페이지 결과 수*/
		        urlBuilder.append("&" + URLEncoder.encode("dataType","UTF-8") + "=" + URLEncoder.encode("JSON", "UTF-8")); /*요청자료형식(XML/JSON) Default: XML*/
		        urlBuilder.append("&" + URLEncoder.encode("base_date","UTF-8") + "=" + URLEncoder.encode("20230719", "UTF-8")); /*‘21년 6월 28일 발표*/
